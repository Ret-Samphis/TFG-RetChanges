...
function removeGTCEURecipes(event) {
	...
	event.remove({ id: 'gtceu:steam_boiler/minecraft_blaze_rod' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_blaze_rod' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_bookshelf' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_bookshelf' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_fishing_rod' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_fishing_rod' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_chiseled_bookshelf' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_chiseled_bookshelf' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_composter' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_composter' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_wooden_hoe' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_wooden_hoe' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_dried_kelp_block' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_dried_kelp_block' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_wooden_shovel' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_wooden_shovel' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_wooden_pickaxe' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_wooden_pickaxe' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_wooden_axe' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_wooden_axe' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_dead_bush' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_dead_bush' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_azalea' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_azalea' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_coal' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_coal' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_fletching_table' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_fletching_table' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_mangrove_roots' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_mangrove_roots' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_crafting_table' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_crafting_table' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_trapped_chest' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_trapped_chest' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_wooden_sword' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_wooden_sword' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_flowering_azalea' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_flowering_azalea' })
	event.remove({ id: 'gtceu:steam_boiler/minecraft_barrel' })
	event.remove({ id: 'gtceu:large_boiler/minecraft_barrel' })
